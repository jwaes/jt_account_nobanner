...
class IrActionsReport(models.Model):
    ...
    def retrieve_attachment(self, record):
        ...
        if self.report_name == 'jt_account_nobanner.report_original_vendor_bill' and record.message_main_attachment_id:
    ...
    def _post_pdf(self, save_in_attachment, pdf_content=None, res_ids=None):
        ...
        if self.report_name == 'jt_account_nobanner.report_original_vendor_bill':
            pdf_content = None
            res_ids = None
    ...
    def _postprocess_pdf_report(self, record, buffer):
        # don't save the 'jt_account_nobanner.report_original_vendor_bill' report as it's just a mean to print existing attachments
        if self.report_name == 'jt_account_nobanner.report_original_vendor_bill':
            return None
